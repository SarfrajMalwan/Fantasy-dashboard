...
const navigation = (): HorizontalNavItemsType => {
  ...
  const store = useAppUtils.getState()

  if (router.pathname.startsWith('/football')) {
    useAppUtils.setState('football')
    return [
      {
        title: 'Dashboards',
        ...
        children: [
          {
            title: 'CRM',
            path: '/football/dashboards/crm',
            gameIds: [1, 2],
            moduleId: 1
          },
          {
            title: 'Analytics',
            path: '/football/dashboards/analytics',
            gameIds: [1, 2],
            moduleId: 1
          },
          {
            title: 'eCommerce',
            path: '/football/dashboards/ecommerce',
            gameIds: [1, 2],
            moduleId: 1
          }
        ]
...

      {
        ...
        path: '/football/apps/season/list',
        gameIds: [1, 2],
        moduleId: 1
      },

      {
        title: 'Competitions',
        icon: 'mdi:tournament',
        path: '/football/apps/competitions/list',
        gameIds: [1, 2],
        moduleId: 1
      },
      {
        title: 'Rounds',
        icon: 'mdi:reload',
        path: '/football/apps/rounds/list',
        gameIds: [1, 2],
        moduleId: 1
      },

      {
        title: 'Matches',
        icon: 'mdi:fencing',
        path: '/football/apps/matches/list',
        gameIds: [1, 2],
        moduleId: 1
      },

      {
        ...
        path: '/football/apps/players/list',
        gameIds: [1, 2],
        moduleId: 1
      },
      {
      ...
      },
      {
        ...
        icon: 'mdi:tournament',
        path: '/football/apps/comp-team-players/list',
        gameIds: [1, 2],
        moduleId: 1
      },

      {
        title: 'Countries',
        icon: 'mdi:earth',
        path: '/football/apps/countries/list',
        gameIds: [1, 2],
        moduleId: 1
      },
      {
        ...
        path: '/football/apps/venues/list',
        gameIds: [1, 2],
        moduleId: 1
      },
      {
        title: 'Officials',
        icon: 'mdi:account',
        path: '/football/apps/officials/list',
        gameIds: [1, 2],
        moduleId: 1
      }
    ...
    return [
      ...
      },
      {
        title: 'Comp. Team Players',
        icon: 'mdi:tournament',
        path: '/apps/comp-team-players/list',
        gameIds: [1, 2],
        moduleId: 1
      },
