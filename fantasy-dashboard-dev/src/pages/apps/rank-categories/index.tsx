...
import useRankCategory, { RankCategory } from 'src/features/rank-categories/rank.services';

interface CellType {
  row: RankCategory
}

let page_title = "Rank Categories";



type PlanListColumn = Omit<GridColDef, 'field'> & { field: keyof RankCategory }
