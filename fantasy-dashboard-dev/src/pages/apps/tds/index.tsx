...
import useTdsStore, { Tds } from "src/features/tds/tds.service";
...
type PlanListColumn = Omit<GridColDef, 'field'> & { field: keyof Tds }
...
const defaultColumns: PlanListColumn[] = [
  ...
  },
  {
    ...
    field: 'pan_no',
    headerName: 'pan_no',
    renderCell: ({ row }: CellType) => <Typography variant='body2'>{row?.pan_no}</Typography>,
  },
