...
import useLeaderboardStore, { Leaderboard } from "src/features/influencer/leaderboard.service";
...
let page_title = "Influencer Leaderboard";
...
const defaultColumns: PlanListColumn[] = [
  ...
  },
  {
    ...
    headerName: 'Deposit',
    editable: true,
    renderCell: ({ row }: CellType) => <Typography variant='body2'>{row?.deposit}</Typography>
  },
