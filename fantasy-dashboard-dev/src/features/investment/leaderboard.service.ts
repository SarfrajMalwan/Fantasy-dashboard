...
let timeOut: any
const path = '/investment-leaderboard'

const useInvestmentLeaderboard = create(
  combine({
    leaderboard: {
      id: null as any,
      list: [] as Leaderboard[],
      ...
      get: {
        ...
        paginate: ({
          ...
          const init = () => {
            ...
            useInvestmentLeaderboard.getState().get.list()
          }
...
export default useInvestmentLeaderboard
