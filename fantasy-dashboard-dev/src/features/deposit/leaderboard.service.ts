...
let timeOut: any
const path = '/deposit-leaderboard'

const useDepositLeaderboardStore = create(
  combine({
    leaderboard: {
      id: null as any,
      list: [] as Leaderboard[],
      ...
      get: {
        ...
        paginate: ({
          ...
          const init = () => {
            ...
            useDepositLeaderboardStore.getState().get.list()
          }
...
export default useDepositLeaderboardStore
